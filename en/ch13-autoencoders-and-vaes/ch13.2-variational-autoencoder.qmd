...
[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/en/ch13-autoencoders-and-vaes/ch13.2-variational-autoencoder.ipynb){fig-align="left"}
...
![Figure 13.2.1: VAE network structure [@IBM2026VAE]](figures/ch13.2-vae.png){width=70%}
...
For the line `std = (0.5 * logvar).exp()`, we have:
