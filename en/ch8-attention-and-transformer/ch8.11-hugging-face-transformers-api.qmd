...
- - Token IDs
  - The `inputs['input_ids']` tensor

- - Padding mask
  - The `inputs['attention_mask']` tensor
...
- - Token representations
  - The `outputs.last_hidden_state` attribute

- - Classification scores
  - The `outputs.logits` attribute

- - Hidden states at each layer
  - The `output_hidden_states=True` option / `outputs.hidden_states` attribute

- - Attention weights
  - The `output_attentions=True` option / `outputs.attentions` attribute

- - Cross-attention weights
  - The `outputs.cross_attentions` attribute

- - Autoregressive generation
  - The `model.generate(...)` method

- - KV cache
  - The `use_cache=True` option / `outputs.past_key_values` attribute

- - Training loss
  - The `labels=...` argument / `outputs.loss` attribute
:::
