...
## 8.11.2 AutoTokenizer: From Text to Token IDs
...
## 8.11.3 AutoModel: Only the Transformer Backbone
...
## 8.11.4 SequenceClassification: Encoder + Classification Head
...
## 8.11.5 TokenClassification: One Prediction per Token
...
## 8.11.6 CausalLM: Decoder-Only Language Models
...
## 8.11.7 `generate`: The Wrapper for Autoregressive Generation
...
## 8.11.8 `use_cache`: The KV Cache Interface
...
## 8.11.9 AutoModelForSeq2SeqLM: Encoder-Decoder Generation Models
...
## 8.11.10 `output_attentions`: Extracting Attention Weights
...
## 8.11.11 `hidden_states`: Extracting Layer Representations
...
## 8.11.12 ModelOutput: Why It Is Not an Ordinary Tuple
...
## 8.11.13 `labels`: Where the Training Loss Comes From
...
## 8.11.14 A Mapping Table from Structure to API
...
## 8.11.15 A Complete Decoder-Only Example
...
## 8.11.16 A Complete Encoder-Only Example
...
## 8.11.17 A Complete Encoder-Decoder Example
...
## 8.11.18 An Attention Visualization Interface Example
