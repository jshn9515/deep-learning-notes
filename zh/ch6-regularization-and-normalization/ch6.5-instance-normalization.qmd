...
title: "6.5 InstanceNorm：对样本的每个通道进行归一化"
order: 5
---

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/zh/ch6-regularization-and-normalization/ch6.5-instance-normalization.ipynb){fig-align="left"}
...
## 6.5.2 BatchNorm、LayerNorm 和 InstanceNorm 的统计方向
...
## 6.5.3 为什么 InstanceNorm 常用于风格迁移
...
## 6.5.4 InstanceNorm 也会进行可学习的仿射变换
...
## 6.5.5 InstanceNorm 的 PyTorch 实现
...
## 6.5.6 InstanceNorm1d、InstanceNorm2d 和 InstanceNorm3d
