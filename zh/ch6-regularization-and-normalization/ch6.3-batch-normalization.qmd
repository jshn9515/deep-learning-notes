...
title: "6.3 BatchNorm：利用 batch 统计量稳定训练"
order: 3
---

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/zh/ch6-regularization-and-normalization/ch6.3-batch-normalization.ipynb){fig-align="left"}
...
## 6.3.3 为什么标准化以后还需要 gamma 和 beta
...
## 6.3.6 Running Statistics 和 Momentum
...
## 6.3.8 BatchNorm1d、BatchNorm2d 和 BatchNorm3d
...
## 6.3.9 Conv-BN Fusion：为什么推理时可以合并
...
## 6.3.10 Conv-BN Fusion 的 PyTorch 实现
