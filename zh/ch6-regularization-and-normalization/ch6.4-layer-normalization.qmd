...
title: "6.4 LayerNorm：在单个样本内部归一化特征"
order: 4
---

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/zh/ch6-regularization-and-normalization/ch6.4-layer-normalization.ipynb){fig-align="left"}
...
## 6.4.3 normalized_shape：决定归一化维度和参数形状
...
## 6.4.4 Transformer 中的 LayerNorm
...
## 6.4.5 LayerNorm 不依赖 batch statistics
