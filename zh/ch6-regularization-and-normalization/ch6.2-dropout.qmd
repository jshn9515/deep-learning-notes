...
title: "6.2 Dropout：通过随机失活减少过拟合"
order: 2
---

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/zh/ch6-regularization-and-normalization/ch6.2-dropout.ipynb){fig-align="left"}
...
![图 6.2.1 Dropout 让网络在训练时随机选择子网络 [@zhang2023d2l, fig. 4.6.1]](figures/ch6.2-dropout.svg)
...
## 6.2.8 Dropout1d、Dropout2d 和 Dropout3d
...
::: {.list-table}
表 6.2.8 PyTorch 中不同 Dropout 模块的典型输入
