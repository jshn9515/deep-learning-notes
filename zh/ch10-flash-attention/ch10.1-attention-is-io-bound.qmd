...
<figure class="figure" style="text-align: center;">
  <img src="figures/ch10.1-gpu-memory.png" alt="图 1：GPU 内存分层模型" style="width: 40%;">
  <figcaption>图 1：GPU 内存分层模型 [@dao2022FlashAttentionv1, fig. 1]</figcaption>
</figure>
...
<figure class="figure" style="text-align: center;">
  <img src="figures/ch10.1-attn-forward.png" alt="算法 1：标准 Attention 的执行流程" style="width: 100%;">
  <figcaption>算法 1：标准 attention 的执行流程 [@dao2022FlashAttentionv1, alg. 0]</figcaption>
</figure>
