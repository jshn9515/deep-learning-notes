...
open-graph:
  title: ch19.9-distributed-training
  description: "19.9 Distributed Training: Intuition for DDP, ZeRO, and FSDP"
title: "19.9 分布式训练入门：DDP、ZeRO 与 FSDP 的直觉"
order: 9
---
...
![图 19.9.3 DDP 模型结构](figures/ch19.9-ddp.svg){width=80%}
...
![图 19.9.4 DDP backward 中的 overlap](figures/ch19.9-ddp-overlap.svg)
...
![图 19.9.6.1 reduce-scatter 示意图](figures/ch19.9-reduce-scatter.svg){height=180px}

于是，一整个 block 可以粗略画成：

![图 19.9.6.2 ZeRO-3 中 block 的计算流程](figures/ch19.9-block-life-cycle.svg){height=300px}
...
![图 19.9.10 ZeRO 的渐进式分片](figures/ch19.9-ddp-zero-fsdp.svg){height=360px}
...
![图 19.9.12 选择 DDP / ZeRO / FSDP 的直觉流程](figures/ch19.9-summary.svg)
