...
![图 3.1.1：MNIST 手写数字分类数据集 [@enwiki:MNIST]](figures/ch3.1-mnist-samples.png)
...
![图 3.1.3：线性分类器模型 [@zhang2023d2l, fig. 3.1.2]](figures/ch3.1-single-neuron.svg)
...
![图 3.1.6：MLP 模型 [@zhang2023d2l, fig. 4.1.1]](figures/ch3.1-mlp.svg)
