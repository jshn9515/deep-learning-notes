...
open-graph:
  title: ch12.3-profiling
  description: "12.3 Profiling: How to Find Where Your Code Is Slow"
title: "12.3 Profiling：怎么知道代码慢在哪里"
order: 3
---

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/zh/ch12-llm-training-engineering/ch12.3-profiling.ipynb){fig-align="left"}
...
## 12.3.2 Step Time：最简单的 Benchmark
...
## 12.3.3 CUDA 是异步的：错误计时可能只测到 Kernel Launch
...
![图 12.3.3 GPU 异步执行示意图](figures/ch12.3-gpu-execution.svg){width=80%}
...
## 12.3.4 torch.Event：单独测 GPU 执行时间
...
## 12.3.5 torch.profiler：把一个 Step 拆成 Operator
...
## 12.3.7 record_function：给训练循环划分区域
...
![](results/ch12.3.7_trace_result.png)
...
## 12.3.8 Timeline：CPU 和 GPU 到底谁在等谁
...
![图 12.3.8 Profiler Timeline](figures/ch12.3-gpu-timeline.svg){width=80%}
...
![图 12.3.10 Profiler 分层分析](figures/ch12.3-profiling-steps.svg){height=750px}
