...
open-graph:
  title: ch12.8-triton
  description: "12.8 Triton: When Do We Need to Write Our Own Kernel?"
title: "12.8 Triton 入门：什么时候需要自己写 Kernel"
order: 8
---

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/zh/ch12-llm-training-engineering/ch12.8-triton.ipynb){fig-align="left"}
...
## 12.8.1 为什么 PyTorch 代码不一定等于一个 kernel
...
![图 12.8.1.1 PyTorch Eager Expression](figures/ch12.8-tensor-op.svg)
...
![图 12.8.1.2 Fused Kernel](figures/ch12.8-fused-kernel.svg){height=260px}
...
## 12.8.2 Triton 的基本执行模型：一个 Program 处理一块数据
...
## 12.8.3 第一个 Triton Kernel：Vector Addition
...
![图 12.8.3 Triton 的执行顺序](figures/ch12.8-triton-execution.svg){height=450px}
...
## 12.8.6 从多个 Operator 到一个 Kernel：Fused SwiGLU
...
![图 12.8.6.1 PyTorch Eager Expression](figures/ch12.8-swiglu-eager.svg){height=550px}

而 Triton fused kernel 可以把中间结果保留在当前 program 的计算过程中：

![图 12.8.6.2 Triton Fused Kernel](figures/ch12.8-swiglu-fused.svg){height=260px}
...
## 12.8.9 为什么训练 Kernel 比 Forward Demo 更难
...
![图 12.8.10 Triton Fusion 判断顺序](figures/ch12.8-summary.svg){height=550px}
