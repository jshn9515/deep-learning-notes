...
open-graph:
  title: ch12.7-modern-attention-apis
  description: "12.7 Modern Attention APIs and Hugging Face Kernels"
title: "12.7 现代 Attention API 与 Hugging Face Kernels"
order: 7
---

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/zh/ch12-llm-training-engineering/ch12.7-modern-attention-apis.ipynb){fig-align="left"}
...
## 12.7.1 SDPA：PyTorch 的统一 Attention 入口
...
## 12.7.2 SDPA 为什么比手写 Attention 更适合作为默认实现
...
## 12.7.3 torch.nn.attention：控制 SDPA 行为的命名空间
...
### 12.7.3.1 SDPBackend：SDPA 有哪些后端
...
## 12.7.4 FlexAttention：当 SDPA 的 Mask 不够灵活
...
## 12.7.5 xFormers：PyTorch 原生 SDPA 之前的重要高效算子库
...
## 12.7.6 Hugging Face kernels：从 Hub 动态加载 kernel
