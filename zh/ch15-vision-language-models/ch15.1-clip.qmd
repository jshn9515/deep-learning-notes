...
![图 1：CLIP 网络结构 [@radford2021CLIP, fig. 1]](figures/ch15.1-clip.png){width="60%"}
...
![图 2：CLIP zero-shot 分类 [@radford2021CLIP, fig. 1]](figures/ch15.1-clip-zero-shot.png){width="60%"}
