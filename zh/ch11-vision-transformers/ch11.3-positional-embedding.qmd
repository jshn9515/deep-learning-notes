...
[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/zh/ch11-vision-transformers/ch11.3-positional-embedding.ipynb){fig-align="left"}
...
1. 这里的 `Dropout` 是可选的。原始 ViT 在输入模块后面没有加 dropout，但很多后来的变体会在这里加一个 dropout 层，用来增加输入的随机性，提升模型的泛化能力。
