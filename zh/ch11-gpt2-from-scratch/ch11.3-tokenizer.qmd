...
title: "11.3 Tokenizer：字符、BPE 与词表"
order: 4
---

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/zh/ch11-gpt2-from-scratch/ch11.3-tokenizer.ipynb){fig-align="left"}

前面几节里，我们已经把 MiniGPT 的主体搭起来了：

![图 11.3.0 MiniGPT 的数据流](figures/ch11.3-token-generation-loop.svg){height=450px}
...
## 11.3.3 词级 Tokenizer：看起来自然，但问题更多
...
## 11.3.4 子词级 Tokenizer：介于字符和单词之间
...
## 11.3.5 Byte-level BPE：为什么 GPT 不只是按字符切
...
## 11.3.7 从 Tokenizer 到训练样本

现在我们可以把 11.1 的 next-token prediction 和这一节的 tokenizer 接起来。
