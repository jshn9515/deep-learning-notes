...
title: "11.6 从训练到生成：Temperature、Top-k、Top-p"
order: 6
eval: false
---

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/zh/ch11-gpt2-from-scratch/ch11.6-generation.ipynb){fig-align="left"}
...
## 11.6.3 Top-k：只在概率最高的 k 个 token 里采样
...
## 11.6.5 把 Temperature、Top-k、Top-p 合在一起
