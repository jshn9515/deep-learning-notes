...
title: "11.2 MiniGPT：从 Causal GPT Block 到语言模型"
order: 2
---

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/zh/ch11-gpt2-from-scratch/ch11.2-minigpt.ipynb){fig-align="left"}
...
![图 11.2.0 MiniGPT 的数据流](figures/ch11.2-minigpt-data-flow.svg){height=500px}
...
## 11.2.1 从 Transformer Decoder 到 MiniGPT
...
## 11.2.2 Causal Self-Attention：训练时并行，但不能看到未来
...
## 11.2.4 从 Token IDs 到 Hidden States
...
## 11.2.5 从 Hidden States 到词表 Logits
...
![图 11.2.8 MiniGPT 的数据流](figures/ch11.2-generation-loop.svg){height=500px}

后面讲 generation 时，我们会在这个基础上加入 temperature、top-k 和 top-p sampling。

## 11.2.9 MiniGPT 的参数在哪里
