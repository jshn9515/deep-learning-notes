...
title: "11.5 在 TinyStories 上训练 MiniGPT"
order: 5
eval: false
---

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/zh/ch11-gpt2-from-scratch/ch11.5-training-minigpt.ipynb){fig-align="left"}
...
![图 11.5.0 MiniGPT 训练流程](figures/ch11.5-training-pipeline.svg){height=650px}
...
## 11.5.2 Hugging Face Tokenizers 库简介
...
![图 11.5.2 Hugging Face Tokenizers 组件](figures/ch11.5-tokenizer-components.svg){height=550px}

下面分别看这些组件负责什么。

### 11.5.2.1 Normalizer：统一同一种文本的不同写法
...
### 11.5.2.2 Pre-tokenizer：先规定 BPE 不能跨过哪些边界
...
### 11.5.2.4 Post-processor：在 tokenization 之后整理 Encoding
...
### 11.5.2.5 Decoder：把内部 token 表示还原成可读字符串
...
## 11.5.4 从 Document 变成 Token Stream
