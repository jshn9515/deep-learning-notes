...
[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/zh/ch8-attention-and-transformer/ch8.8-encoder-decoder-transformer.ipynb){fig-align="left"}
...
![图 8.8.2：Transformer 网络结构图 [@vaswani2023Attention, fig. 1]](figures/ch8.8-transformer.png){height=600px}
...
## 8.8.6 Transformer 的 PyTorch 实现
...
## 8.8.7 Seq2Seq Transformer 的 PyTorch 实现
...
## 8.8.8 Seq2Seq Transformer 的训练流程
