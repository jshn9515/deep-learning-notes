...
def _conv_nd(
    ...
    output_dim = []
    for r, k, s, d in zip(x.shape[2:], kernel_size, stride, dilation, strict=True):
        output_dim.append((r - d * (k - 1) - 1) // s + 1)
